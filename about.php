...
<head>
  ...
  <title>About Us | CAMPUS2COMMUNITY (C2C) Sovereign Platform</title>
  ...
  <style>
    ...
    @keyframes orb-float-1 {
      ...
      33% { transform: translate(50px, -40px) scale(1.18) rotate(20deg); }
      66% { transform: translate(-40px, 30px) scale(0.90) rotate(-15deg); }
    }

    @keyframes orb-float-2 {
      0%, 100% { transform: translate(0px, 0px) scale(1) rotate(0deg); }
      33% { transform: translate(-45px, 45px) scale(1.22) rotate(-25deg); }
      66% { transform: translate(40px, -30px) scale(0.92) rotate(20deg); }
    }

    @keyframes orb-float-3 {
      0%, 100% { transform: translate(-50%, 0px) scale(1); opacity: 0.7; }
      50% { transform: translate(-50%, 35px) scale(1.12); opacity: 1; }
    }

    @keyframes aurora-pulse {
      0%, 100% { opacity: 0.55; filter: blur(100px); }
      50% { opacity: 0.85; filter: blur(120px); }
    }
...
<body class="bg-[#F4F9FD] dark:bg-[#07111F] text-slate-800 dark:text-slate-100 min-h-screen selection:bg-brand-pastel selection:text-brand-deep transition-colors duration-300">
  ...
  <header class="fixed top-0 left-0 right-0 z-50 glass-sky border-b border-[#D8E8F5] dark:border-slate-800 transition-all duration-300 shadow-sm">
    <div class="h-16 w-full max-w-[1520px] mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between gap-2 lg:gap-3">
      ...
      <div class="flex items-center gap-2.5 shrink-0">
        <a href="code.html#home" class="flex items-center gap-2 group focus:outline-none">
          ...
          <div class="flex flex-col">
            <div class="flex items-center gap-1">
              ...
              <span class="px-1.5 py-0.2 rounded bg-brand-pastel/80 dark:bg-sky-900/50 text-[9px] font-bold text-brand-deep dark:text-sky-300 uppercase tracking-wide">About</span>
            </div>
      ...
      <nav class="hidden lg:flex items-center p-1 rounded-full bg-[#EBF5FC]/90 dark:bg-slate-900/90 border border-[#CAE7F7] dark:border-slate-800 gap-0.5 shadow-sm shrink-0" id="main-nav">
        <a href="code.html#home" class="nav-pill whitespace-nowrap px-3 py-1.5 rounded-full text-[12px] font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-deep transition-all flex items-center gap-1.5">
          <span class="material-symbols-outlined text-[15px] leading-none">home</span>
          <span data-i18n="nav_home">Home</span>
        </a>
        <a href="#mission" class="nav-pill active whitespace-nowrap px-3 py-1.5 rounded-full text-[12px] font-bold text-slate-700 dark:text-slate-300 hover:text-brand-deep transition-all flex items-center gap-1.5">
          <span class="material-symbols-outlined text-[15px] leading-none">target</span>
          <span data-i18n="nav_mission">Mission</span>
        </a>
        <a href="#journey" class="nav-pill whitespace-nowrap px-3 py-1.5 rounded-full text-[12px] font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-deep transition-all flex items-center gap-1.5">
          <span class="material-symbols-outlined text-[15px] leading-none">history_edu</span>
          <span data-i18n="nav_timeline">Timeline</span>
        </a>
        <a href="#pillars" class="nav-pill whitespace-nowrap px-3 py-1.5 rounded-full text-[12px] font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-deep transition-all flex items-center gap-1.5">
          <span class="material-symbols-outlined text-[15px] leading-none">foundation</span>
          <span data-i18n="nav_pillars">Pillars</span>
        </a>
        <a href="#leadership" class="nav-pill whitespace-nowrap px-3 py-1.5 rounded-full text-[12px] font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-deep transition-all flex items-center gap-1.5">
          <span class="material-symbols-outlined text-[15px] leading-none">group</span>
          <span data-i18n="nav_leadership">Leadership</span>
        </a>
        <a href="#stakeholders" class="nav-pill whitespace-nowrap px-3 py-1.5 rounded-full text-[12px] font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-deep transition-all flex items-center gap-1.5">
          <span class="material-symbols-outlined text-[15px] leading-none">diversity_3</span>
          <span>Stakeholders</span>
        </a>
        <a href="#faq" class="nav-pill whitespace-nowrap px-3 py-1.5 rounded-full text-[12px] font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-deep transition-all flex items-center gap-1.5">
          <span class="material-symbols-outlined text-[15px] leading-none">help</span>
          <span>FAQ</span>
        </a>
      </nav>
      ...
      <div class="flex items-center gap-2 shrink-0">
        ...
        <a href="code.html#challenges" class="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-sky-600 to-brand-primary text-white font-headline text-xs font-bold shadow-sm hover:shadow-md hover:scale-[1.02] active:scale-95 transition-all whitespace-nowrap">
    ...
    <div id="mobile-menu" class="hidden lg:hidden border-t border-[#D8E8F5] dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl px-4 py-4 space-y-2">
      <a href="code.html#home" onclick="toggleMobileMenu()" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 hover:bg-brand-pastel/60">
        <span class="material-symbols-outlined text-brand-primary text-[20px]">home</span>
        <span>Home Overview</span>
      </a>
      <a href="#mission" onclick="toggleMobileMenu()" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 hover:bg-brand-pastel/60">
        <span class="material-symbols-outlined text-brand-primary text-[20px]">target</span>
        <span>Mission & Vision</span>
      </a>
      <a href="#journey" onclick="toggleMobileMenu()" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 hover:bg-brand-pastel/60">
        <span class="material-symbols-outlined text-brand-primary text-[20px]">history_edu</span>
        <span>C2C Timeline</span>
      </a>
      <a href="#pillars" onclick="toggleMobileMenu()" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 hover:bg-brand-pastel/60">
        <span class="material-symbols-outlined text-brand-primary text-[20px]">foundation</span>
        <span>Core Pillars</span>
      </a>
      <a href="#leadership" onclick="toggleMobileMenu()" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 hover:bg-brand-pastel/60">
        <span class="material-symbols-outlined text-brand-primary text-[20px]">group</span>
        <span>Leadership Council</span>
      </a>
      <a href="#stakeholders" onclick="toggleMobileMenu()" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 hover:bg-brand-pastel/60">
        <span class="material-symbols-outlined text-brand-primary text-[20px]">diversity_3</span>
        <span>Stakeholder Benefits</span>
      </a>
      <a href="#faq" onclick="toggleMobileMenu()" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-800 dark:text-slate-200 hover:bg-brand-pastel/60">
        <span class="material-symbols-outlined text-brand-primary text-[20px]">help</span>
        <span>Frequently Asked Questions</span>
      </a>
      <div class="pt-2 border-t border-slate-200 dark:border-slate-800">
        <a href="code.html#challenges" onclick="toggleMobileMenu()" class="w-full py-2.5 rounded-xl bg-brand-primary text-white font-bold flex items-center justify-center gap-2 text-sm shadow-md">
  ...
  <main class="pt-20 pb-20 overflow-x-hidden">
    ...
    <!-- HERO SECTION -->
    <section id="hero" class="relative w-full overflow-hidden pt-10 pb-16 lg:pb-24">
      <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[950px] h-[540px] bg-gradient-to-b from-[#CAE7F7]/60 via-[#DCEEFB]/40 to-transparent dark:from-sky-500/30 dark:via-cyan-400/20 dark:to-transparent blur-[110px] pointer-events-none -z-10 animate-orb-3"></div>
      ...
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div class="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/90 dark:bg-slate-800/90 border border-[#CAE7F7] dark:border-slate-700 shadow-sky-sm mb-6">
          ...
          <span class="font-headline text-[12px] font-bold text-brand-deep dark:text-sky-300 tracking-wider uppercase">SIH 2026 Sovereign Initiative</span>
          <span class="text-slate-300 dark:text-slate-600">•</span>
          <span class="text-[12px] font-semibold text-slate-600 dark:text-slate-300">Empowering 32,000+ Innovators</span>
        </div>

        <h1 class="font-headline font-extrabold text-4xl sm:text-5xl lg:text-6xl text-center max-w-5xl tracking-tight text-slate-900 dark:text-white mb-6 leading-[1.15]">
          Bridging Campuses & Communities for <span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-600 via-brand-primary to-indigo-600 dark:from-sky-300 dark:via-cyan-300 dark:to-indigo-300 animate-gradient-text">Real-World Civic Impact.</span>
        </h1>

        

        <!-- Hero CTAs -->
        <div class="flex flex-wrap items-center justify-center gap-4 mb-16 z-10">
          <a href="code.html#challenges" class="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-sky-600 to-brand-primary text-white font-headline text-sm font-bold shadow-sky-md hover:shadow-sky-lg hover:scale-[1.02] active:scale-95 transition-all">
            <span class="material-symbols-outlined text-[20px]">hub</span>
            <span>Explore Active Platform Mesh</span>
            <span class="material-symbols-outlined text-[18px]">arrow_forward</span>
          </a>
          <a href="#mission" class="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-white dark:bg-slate-800 text-slate-800 dark:text-white border border-[#CAE7F7] dark:border-slate-700 font-headline text-sm font-bold shadow-sky-sm hover:bg-brand-tint dark:hover:bg-slate-700 transition-all">
            <span class="material-symbols-outlined text-brand-primary text-[20px]">target</span>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 w-full max-w-5xl">
          <div class="rounded-2xl glass-card p-5 text-center border border-[#D5E8F7] dark:border-slate-800 shadow-sky-sm hover:scale-105 transition-all">
            <div class="w-10 h-10 mx-auto rounded-xl bg-brand-pastel/70 text-brand-deep flex items-center justify-center mb-3">
              <span class="material-symbols-outlined text-2xl">school</span>
            </div>
            <div class="font-headline font-extrabold text-2xl sm:text-3xl text-slate-900 dark:text-white">412+</div>
            <div class="text-xs font-semibold text-slate-500 dark:text-slate-400 mt-1">Accredited Campuses</div>
          </div>

          <div class="rounded-2xl glass-card p-5 text-center border border-[#D5E8F7] dark:border-slate-800 shadow-sky-sm hover:scale-105 transition-all">
            <div class="w-10 h-10 mx-auto rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center mb-3">
              <span class="material-symbols-outlined text-2xl">engineering</span>
            </div>
            <div class="font-headline font-extrabold text-2xl sm:text-3xl text-slate-900 dark:text-white">32,480+</div>
            <div class="text-xs font-semibold text-slate-500 dark:text-slate-400 mt-1">Student Innovators</div>
          </div>

          <div class="rounded-2xl glass-card p-5 text-center border border-[#D5E8F7] dark:border-slate-800 shadow-sky-sm hover:scale-105 transition-all">
            <div class="w-10 h-10 mx-auto rounded-xl bg-amber-100 text-amber-700 flex items-center justify-center mb-3">
              <span class="material-symbols-outlined text-2xl">task_alt</span>
            </div>
            <div class="font-headline font-extrabold text-2xl sm:text-3xl text-slate-900 dark:text-white">1,284</div>
            <div class="text-xs font-semibold text-slate-500 dark:text-slate-400 mt-1">Ground Issues Resolved</div>
          </div>

          <div class="rounded-2xl glass-card p-5 text-center border border-[#D5E8F7] dark:border-slate-800 shadow-sky-sm hover:scale-105 transition-all">
            <div class="w-10 h-10 mx-auto rounded-xl bg-indigo-100 text-indigo-700 flex items-center justify-center mb-3">
              <span class="material-symbols-outlined text-2xl">payments</span>
            </div>
            <div class="font-headline font-extrabold text-2xl sm:text-3xl text-slate-900 dark:text-white">₹4.8 Cr</div>
            <div class="text-xs font-semibold text-slate-500 dark:text-slate-400 mt-1">CSR Escrow Grants</div>
          </div>
        </div>
    ...
    <section id="mission" class="py-16 bg-white/60 dark:bg-slate-900/40 border-y border-[#D8E8F5] dark:border-slate-800">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        
        <div class="text-center max-w-3xl mx-auto mb-14">
          <span class="px-3 py-1 rounded-full bg-brand-pastel text-brand-deep text-xs font-bold uppercase tracking-wider">Purpose & Mandate</span>
          <h2 class="font-headline font-extrabold text-3xl sm:text-4xl text-slate-900 dark:text-white mt-3">Driven by Impact. Orchestrated by Intelligence.</h2>
          <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-3">We eliminate traditional bureaucratic bottlenecks between academic labs and municipal public works departments.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <!-- Vision Card -->
          <div class="rounded-3xl glass-card p-8 sm:p-10 border border-[#D5E8F7] dark:border-slate-800 relative overflow-hidden group hover:border-brand-accent transition-all">
            <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500 to-brand-primary text-white flex items-center justify-center mb-6 shadow-md">
              <span class="material-symbols-outlined text-3xl">visibility</span>
            </div>
            <h3 class="font-headline font-extrabold text-2xl text-slate-900 dark:text-white mb-4">Our Vision</h3>
            <p class="text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
              To establish a nationwide digital grid where zero citizen distress calls go unanswered, and every engineering student graduates with verified, real-world societal problem-solving experience backed by government NOC clearance and institutional recognition.
            </p>
            <div class="mt-6 flex flex-wrap gap-2">
              <span class="px-3 py-1 rounded-lg bg-brand-pastel text-brand-deep font-bold text-xs">Zero Paper Bureaucracy</span>
              <span class="px-3 py-1 rounded-lg bg-sky-100 dark:bg-slate-800 text-sky-800 dark:text-sky-300 font-bold text-xs">Sub-24h Dispatch</span>
              <span class="px-3 py-1 rounded-lg bg-emerald-100 dark:bg-slate-800 text-emerald-800 dark:text-emerald-300 font-bold text-xs">Verified Impact</span>
            </div>
          </div>

          <!-- Mission Card -->
          <div class="rounded-3xl glass-card p-8 sm:p-10 border border-[#D5E8F7] dark:border-slate-800 relative overflow-hidden group hover:border-brand-accent transition-all">
            <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center mb-6 shadow-md">
              <span class="material-symbols-outlined text-3xl">flag</span>
            </div>
            <h3 class="font-headline font-extrabold text-2xl text-slate-900 dark:text-white mb-4">Our Mission</h3>
            <p class="text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
              To seamlessly unify the Ministry of Education, AICTE academic frameworks, Municipal Corporations, District Collectors, and Corporate CSR wings under a single cryptographic, AI-driven workflow that matches ground challenges to college labs in real time.
            </p>
            <div class="mt-6 flex flex-wrap gap-2">
              <span class="px-3 py-1 rounded-lg bg-emerald-100 text-emerald-800 dark:bg-slate-800 dark:text-emerald-300 font-bold text-xs">AICTE Credit Rails</span>
              <span class="px-3 py-1 rounded-lg bg-indigo-100 text-indigo-800 dark:bg-slate-800 dark:text-indigo-300 font-bold text-xs">Sec 135 CSR Escrow</span>
              <span class="px-3 py-1 rounded-lg bg-brand-pastel text-brand-deep font-bold text-xs">Smart India Hackathon</span>
            </div>
          </div>
        </div>
    ...
    <!-- C2C TIMELINE & EVOLUTION -->
    <section id="journey" class="py-16">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        
        <div class="text-center max-w-3xl mx-auto mb-16">
          <span class="px-3 py-1 rounded-full bg-brand-pastel text-brand-deep text-xs font-bold uppercase tracking-wider">Evolution Journey</span>
          <h2 class="font-headline font-extrabold text-3xl sm:text-4xl text-slate-900 dark:text-white mt-3">From Hackathon Prototype to Sovereign Infrastructure</h2>
          <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-3">Trace how C2C grew from a SIH 2026 problem statement into a full-scale civic technology mesh.</p>
        </div>

        <div class="relative max-w-4xl mx-auto">
          <!-- Central Line -->
          <div class="absolute left-4 sm:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-sky-400 via-brand-primary to-indigo-500 sm:-translate-x-1/2"></div>

          <!-- Phase 1 -->
          <div class="relative flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 group">
            <div class="sm:w-1/2 sm:pr-10 pl-10 sm:pl-0 sm:text-right mb-2 sm:mb-0">
              <span class="px-2.5 py-0.5 rounded-full bg-brand-pastel text-brand-deep text-[10px] font-extrabold uppercase">Q1 2026 • Genesis</span>
              <h3 class="font-headline font-extrabold text-xl text-slate-900 dark:text-white mt-1">SIH 2026 Innovation Challenge</h3>
              <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mt-2">Conceived during Smart India Hackathon to solve the gap between student capstone projects and actual municipal distress tickets.</p>
            </div>
            <div class="absolute left-0 sm:left-1/2 w-8 h-8 rounded-full bg-brand-primary border-4 border-white dark:border-slate-900 text-white flex items-center justify-center sm:-translate-x-1/2 shadow-md">
              <span class="material-symbols-outlined text-[14px]">lightbulb</span>
            </div>
            <div class="sm:w-1/2 sm:pl-10 pl-10">
              <div class="p-4 rounded-2xl glass-card border border-[#D5E8F7] dark:border-slate-800 text-xs text-slate-500 dark:text-slate-400">
                ⚡ Initial NLP prototype tested with 12 engineering colleges in Maharashtra.
              </div>
            </div>
          </div>
          ...
          <!-- Phase 2 -->
          <div class="relative flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 group">
            <div class="sm:w-1/2 sm:pr-10 pl-10 sm:pl-0 order-2 sm:order-1">
              <div class="p-4 rounded-2xl glass-card border border-[#D5E8F7] dark:border-slate-800 text-xs text-slate-500 dark:text-slate-400">
                🏛️ Onboarded 18 District Collectorates with single-window NOC automated dispatches.
              </div>
            </div>
            <div class="absolute left-0 sm:left-1/2 w-8 h-8 rounded-full bg-emerald-500 border-4 border-white dark:border-slate-900 text-white flex items-center justify-center sm:-translate-x-1/2 shadow-md order-1 sm:order-2">
              <span class="material-symbols-outlined text-[14px]">account_balance</span>
            </div>
            <div class="sm:w-1/2 sm:pl-10 pl-10 sm:text-left mb-2 sm:mb-0 order-1 sm:order-3">
              <span class="px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800 text-[10px] font-extrabold uppercase">Q2 2026 • Municipal Pilots</span>
              <h3 class="font-headline font-extrabold text-xl text-slate-900 dark:text-white mt-1">Civic SLA Integration</h3>
              <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mt-2">Pioneered direct District Collector NOC approvals allowing student teams to test hardware in water plants and roads.</p>
            </div>
          </div>
          ...
          <div class="relative flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 group">
            <div class="sm:w-1/2 sm:pr-10 pl-10 sm:pl-0 sm:text-right mb-2 sm:mb-0">
              <span class="px-2.5 py-0.5 rounded-full bg-indigo-100 text-indigo-800 text-[10px] font-extrabold uppercase">Q3 2026 • Corporate Rails</span>
              <h3 class="font-headline font-extrabold text-xl text-slate-900 dark:text-white mt-1">Sec 135 CSR Escrow Rails</h3>
              <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mt-2">Partnered with corporate CSR boards to disburse micro-grants directly into student team escrow accounts upon milestone proof.</p>
            </div>
            <div class="absolute left-0 sm:left-1/2 w-8 h-8 rounded-full bg-indigo-600 border-4 border-white dark:border-slate-900 text-white flex items-center justify-center sm:-translate-x-1/2 shadow-md">
              <span class="material-symbols-outlined text-[14px]">payments</span>
            </div>
            <div class="sm:w-1/2 sm:pl-10 pl-10">
              <div class="p-4 rounded-2xl glass-card border border-[#D5E8F7] dark:border-slate-800 text-xs text-slate-500 dark:text-slate-400">
                💎 ₹4.8 Crore in corporate funding locked into verified student prototype deployments.
              </div>
            </div>
          </div>
          ...
          <div class="relative flex flex-col sm:flex-row items-start sm:items-center justify-between group">
            <div class="sm:w-1/2 sm:pr-10 pl-10 sm:pl-0 order-2 sm:order-1">
              <div class="p-4 rounded-2xl glass-card border border-[#D5E8F7] dark:border-slate-800 text-xs text-slate-500 dark:text-slate-400">
                🌐 Live AI matching mesh connecting over 400 universities with real-time GIS telemetry.
              </div>
            </div>
            <div class="absolute left-0 sm:left-1/2 w-8 h-8 rounded-full bg-brand-accent border-4 border-white dark:border-slate-900 text-white flex items-center justify-center sm:-translate-x-1/2 shadow-md order-1 sm:order-2">
              <span class="material-symbols-outlined text-[14px]">hub</span>
            </div>
            <div class="sm:w-1/2 sm:pl-10 pl-10 sm:text-left mb-2 sm:mb-0 order-1 sm:order-3">
              <span class="px-2.5 py-0.5 rounded-full bg-brand-pastel text-brand-deep text-[10px] font-extrabold uppercase">Present • Nationwide Grid</span>
              <h3 class="font-headline font-extrabold text-xl text-slate-900 dark:text-white mt-1">State-Wide Mesh Expansion</h3>
              <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mt-2">Scaling C2C to every AICTE accredited institution in India, turning every engineering college into a civic problem-solving hub.</p>
            </div>
          </div>
    ...
    <!-- CORE PILLARS -->
    <section id="pillars" class="py-16 bg-white/60 dark:bg-slate-900/40 border-y border-[#D8E8F5] dark:border-slate-800">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        
        <div class="text-center max-w-3xl mx-auto mb-16">
          <span class="px-3 py-1 rounded-full bg-brand-pastel text-brand-deep text-xs font-bold uppercase tracking-wider">System Architecture</span>
          <h2 class="font-headline font-extrabold text-3xl sm:text-4xl text-slate-900 dark:text-white mt-3">4 Pillars of the C2C Ecosystem</h2>
          <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-3">Built with enterprise-grade reliability, transparent governance, and AI-driven intelligence.</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 hover:shadow-sky-md transition-all flex flex-col justify-between">
            <div>
              <div class="w-12 h-12 rounded-2xl bg-sky-100 text-sky-700 dark:bg-slate-800 dark:text-sky-300 flex items-center justify-center mb-5">
                <span class="material-symbols-outlined text-2xl">psychology</span>
              </div>
              <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white mb-2">AI-Driven Matchmaker</h3>
              <p class="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Transforms vernacular or voice distress reports into structured engineering specs, automatically routing them to department labs based on faculty domain expertise.
              </p>
            </div>
            <div class="mt-6 pt-4 border-t border-[#E2EFF8] dark:border-slate-800 text-[11px] font-bold text-brand-deep dark:text-sky-300 flex items-center gap-1">
          ...
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 hover:shadow-sky-md transition-all flex flex-col justify-between">
            <div>
              <div class="w-12 h-12 rounded-2xl bg-emerald-100 text-emerald-700 dark:bg-slate-800 dark:text-emerald-300 flex items-center justify-center mb-5">
                <span class="material-symbols-outlined text-2xl">lock_clock</span>
              </div>
              <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white mb-2">Escrow Milestone Funding</h3>
              <p class="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Corporate CSR funds are held in automated escrow accounts and released directly to student teams upon verification of prototype deployment by municipal officers.
              </p>
            </div>
            <div class="mt-6 pt-4 border-t border-[#E2EFF8] dark:border-slate-800 text-[11px] font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
              <span>Sec 135 Compliant</span>
              <span class="material-symbols-outlined text-[14px]">arrow_forward</span>
            </div>
          </div>
          ...
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 hover:shadow-sky-md transition-all flex flex-col justify-between">
            <div>
              <div class="w-12 h-12 rounded-2xl bg-indigo-100 text-indigo-700 dark:bg-slate-800 dark:text-indigo-300 flex items-center justify-center mb-5">
                <span class="material-symbols-outlined text-2xl">verified</span>
              </div>
              <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white mb-2">AICTE Academic Sync</h3>
              <p class="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Completed ground solutions automatically grant AICTE Activity Points, count toward capstone credits, and boost university NIRF innovation rankings.
              </p>
            </div>
            <div class="mt-6 pt-4 border-t border-[#E2EFF8] dark:border-slate-800 text-[11px] font-bold text-indigo-600 dark:text-indigo-400 flex items-center gap-1">
              <span>NIRF & Credit Matrix</span>
              <span class="material-symbols-outlined text-[14px]">arrow_forward</span>
            </div>
          </div>
          ...
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 hover:shadow-sky-md transition-all flex flex-col justify-between">
            <div>
              <div class="w-12 h-12 rounded-2xl bg-amber-100 text-amber-700 dark:bg-slate-800 dark:text-amber-300 flex items-center justify-center mb-5">
                <span class="material-symbols-outlined text-2xl">gavel</span>
              </div>
              <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white mb-2">Single-Window NOC Rails</h3>
              <p class="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                District Collectors grant instant digital testing permits for road cutting, sensor installation, or water body sampling with full legal backing.
              </p>
            </div>
            <div class="mt-6 pt-4 border-t border-[#E2EFF8] dark:border-slate-800 text-[11px] font-bold text-amber-600 dark:text-amber-400 flex items-center gap-1">
              <span>District NOC Dispatch</span>
              <span class="material-symbols-outlined text-[14px]">arrow_forward</span>
            </div>
          </div>
    ...
    <section id="leadership" class="py-16">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
          <span class="px-3 py-1 rounded-full bg-brand-pastel text-brand-deep text-xs font-bold uppercase tracking-wider">Founding Team</span>
          <h2 class="font-headline font-extrabold text-3xl sm:text-4xl text-slate-900 dark:text-white mt-3">TEAM</h2>
          <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-3">Students who are innovators, making society better.</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          
          <!-- Team Member 1 -->
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 text-center hover:scale-[1.02] transition-all cursor-pointer" onclick="openBioModal('parnavi')">
            
            <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white">Parnavi Janbhor</h3>
           <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">contact no : 7400429237</p>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Vidyalankar Institute of Technology (VSIT)</p>
          
          </div>

          <!-- Team Member 2 -->
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 text-center hover:scale-[1.02] transition-all cursor-pointer" onclick="openBioModal('rajesh')">
            
            <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white">Tanmay Shirgudi</h3>
           <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">contact no : 8355947969</p>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Vidyalankar Institute of Technology (VSIT)</p>
           
          </div>

          <!-- Team Member 3 -->
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 text-center hover:scale-[1.02] transition-all cursor-pointer" onclick="openBioModal('ananya')">
            
            <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white">Shlok Jadhav</h3>
          <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">contact no : 9152300523</p>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Vidyalankar Institute of Technology (VSIT)</p>
           
          </div>

          <!-- Team Member 4 -->
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 text-center hover:scale-[1.02] transition-all cursor-pointer" onclick="openBioModal('vikram')">
            
            <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white">Shrutesh Gaikwad</h3>
          <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">contact no : 8108759790</p>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Vidyalankar Institute of Technology (VSIT)</p>
          ...
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 text-center hover:scale-[1.02] transition-all cursor-pointer" onclick="openBioModal('parnavi')">
            ...
            <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white">Kashaf Khan</h3>
          <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">contact no : 93218 61070</p>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Vidyalankar Institute of Technology (VSIT)</p>
          ...
          <div class="rounded-3xl glass-card p-6 border border-[#D5E8F7] dark:border-slate-800 text-center hover:scale-[1.02] transition-all cursor-pointer" onclick="openBioModal('parnavi')">
            ...
            <h3 class="font-headline font-bold text-lg text-slate-900 dark:text-white">Aqsa Haji</h3>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">contact no : 96992 56880</p>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Vidyalankar Institute of Technology (VSIT)</p>
    ...
    <!-- STAKEHOLDER MATRIX -->
    <section id="stakeholders" class="py-16 bg-white/60 dark:bg-slate-900/40 border-y border-[#D8E8F5] dark:border-slate-800">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        
        <div class="text-center max-w-3xl mx-auto mb-12">
          <span class="px-3 py-1 rounded-full bg-brand-pastel text-brand-deep text-xs font-bold uppercase tracking-wider">Unified Stakeholder Value</span>
          <h2 class="font-headline font-extrabold text-3xl sm:text-4xl text-slate-900 dark:text-white mt-3">Built for Every Pillar of Society</h2>
          <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-3">Select a stakeholder group to view tailored workflows and platform benefits.</p>
        </div>

        <!-- Stakeholder Nav Tabs -->
        <div class="flex flex-wrap items-center justify-center gap-2 mb-10">
          <button onclick="switchStakeholderTab('students')" id="st-tab-students" class="px-5 py-2.5 rounded-xl text-xs font-bold bg-brand-pastel text-brand-deep shadow-sm transition-all flex items-center gap-2">
            <span class="material-symbols-outlined text-[18px]">school</span>
            <span>Student Innovators</span>
          </button>
          <button onclick="switchStakeholderTab('faculty')" id="st-tab-faculty" class="px-5 py-2.5 rounded-xl text-xs font-semibold text-slate-600 hover:text-brand-deep transition-all flex items-center gap-2">
            <span class="material-symbols-outlined text-[18px]">local_library</span>
            <span>Faculty & Mentors</span>
          </button>
          <button onclick="switchStakeholderTab('municipal')" id="st-tab-municipal" class="px-5 py-2.5 rounded-xl text-xs font-semibold text-slate-600 hover:text-brand-deep transition-all flex items-center gap-2">
            <span class="material-symbols-outlined text-[18px]">location_city</span>
            <span>Municipal Bodies</span>
          </button>
          <button onclick="switchStakeholderTab('csr')" id="st-tab-csr" class="px-5 py-2.5 rounded-xl text-xs font-semibold text-slate-600 hover:text-brand-deep transition-all flex items-center gap-2">
            <span class="material-symbols-outlined text-[18px]">corporate_fare</span>
            <span>CSR & Angel Investors</span>
          </button>
        </div>

        <!-- Stakeholder Views -->
        <div id="st-view-students" class="block">
          <div class="rounded-3xl glass-card p-8 border border-[#D5E8F7] dark:border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="p-4 rounded-2xl bg-brand-tint/60 dark:bg-slate-800/60 border border-[#CAE7F7]">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-brand-primary">verified_user</span>
                <span>AICTE Activity Points</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Earn mandatory AICTE degree activity points by resolving verified community distress tickets in your regional district.</p>
            </div>
            <div class="p-4 rounded-2xl bg-brand-tint/60 dark:bg-slate-800/60 border border-[#CAE7F7]">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-emerald-600">payments</span>
                <span>Direct Hardware Stipends</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Unlock micro-grants from ₹25,000 to ₹2.5 Lakhs directly for sensor purchasing, PCB fabrication, and field testing.</p>
            </div>
            <div class="p-4 rounded-2xl bg-brand-tint/60 dark:bg-slate-800/60 border border-[#CAE7F7]">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-indigo-600">patent</span>
                <span>Provisional IP Rights</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Retain full intellectual property over your engineering solutions with automated patent drafting support from mentor labs.</p>
            </div>
          </div>
        </div>

        <div id="st-view-faculty" class="hidden">
          <div class="rounded-3xl glass-card p-8 border border-[#D5E8F7] dark:border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="p-4 rounded-2xl bg-indigo-50/60 dark:bg-slate-800/60 border border-indigo-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-indigo-600">workspace_premium</span>
                <span>Institutional NIRF Score</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Boost college NIRF research rankings with verified civic prototype deployments and cross-departmental research papers.</p>
            </div>
            <div class="p-4 rounded-2xl bg-indigo-50/60 dark:bg-slate-800/60 border border-indigo-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-brand-primary">co_present</span>
                <span>Inter-College Mentorship</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Co-guide multi-disciplinary student teams across civil, electrical, biotech, and computer science departments.</p>
            </div>
            <div class="p-4 rounded-2xl bg-indigo-50/60 dark:bg-slate-800/60 border border-indigo-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-emerald-600">science</span>
                <span>Lab Equipment Grants</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Unlock corporate CSR hardware grants to upgrade departmental testing facilities and prototyping sandboxes.</p>
            </div>
          </div>
        </div>

        <div id="st-view-municipal" class="hidden">
          <div class="rounded-3xl glass-card p-8 border border-[#D5E8F7] dark:border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="p-4 rounded-2xl bg-emerald-50/60 dark:bg-slate-800/60 border border-emerald-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-emerald-600">speed</span>
                <span>Zero R&D Budget Burden</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Get cutting-edge smart city prototypes built and tested for local municipal issues at zero cost to the civic exchequer.</p>
            </div>
            <div class="p-4 rounded-2xl bg-emerald-50/60 dark:bg-slate-800/60 border border-emerald-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-brand-primary">handshake</span>
                <span>Automated SLA Telemetry</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Monitor ground resolution progress in real time with automated SMS updates and live GIS dashboard tracking.</p>
            </div>
            <div class="p-4 rounded-2xl bg-emerald-50/60 dark:bg-slate-800/60 border border-emerald-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-indigo-600">gavel</span>
                <span>1-Click Digital NOCs</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">District Collectors issue rapid digital testing clearances without tedious physical paper loops.</p>
            </div>
          </div>
        </div>

        <div id="st-view-csr" class="hidden">
          <div class="rounded-3xl glass-card p-8 border border-[#D5E8F7] dark:border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="p-4 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-amber-600">balance</span>
                <span>Companies Act Sec 135 Compliant</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Ensure 100% statutory compliance with audit-ready cryptographic milestone proofs and municipal receipts.</p>
            </div>
            <div class="p-4 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-emerald-600">shield</span>
                <span>Escrow Milestone Safety</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Funds are locked safely in escrow and disbursed only after multi-stakeholder verification of ground results.</p>
            </div>
            <div class="p-4 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-100">
              <div class="font-headline font-bold text-slate-900 dark:text-white mb-2 flex items-center gap-2">
                <span class="material-symbols-outlined text-brand-primary">person_search</span>
                <span>Early Talent Pipeline</span>
              </div>
              <p class="text-xs text-slate-600 dark:text-slate-300">Identify and hire top-tier engineering talent working on high-impact sustainable technologies before graduation.</p>
            </div>
          </div>
        </div>
    ...
    <section id="faq" class="py-16">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-14">
          <span class="px-3 py-1 rounded-full bg-brand-pastel text-brand-deep text-xs font-bold uppercase tracking-wider">Clear Insights</span>
          <h2 class="font-headline font-extrabold text-3xl sm:text-4xl text-slate-900 dark:text-white mt-3">Frequently Asked Questions</h2>
          <p class="text-sm sm:text-base text-slate-600 dark:text-slate-300 mt-3">Everything you need to know about joining or supporting the C2C mesh.</p>
        </div>

        <div class="max-w-3xl mx-auto space-y-4">
          
          <div class="rounded-2xl glass-card p-5 border border-[#D5E8F7] dark:border-slate-800 cursor-pointer" onclick="toggleFaq('faq-1')">
            <div class="flex items-center justify-between font-headline font-bold text-slate-900 dark:text-white text-base">
              <span>How are problem statements reported and verified?</span>
              <span class="material-symbols-outlined text-brand-primary transition-transform duration-200" id="faq-icon-faq-1">expand_more</span>
            </div>
            <div id="faq-1" class="hidden mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-[#E2EFF8] dark:border-slate-800 pt-3">
              Citizens, municipal counselors, or local ward heads submit ground issues via text, photos, or voice notes. The C2C AI semantic engine geotags the issue, removes duplicate entries, and verifies municipal urgency within 24 hours.
            </div>
          </div>

          <div class="rounded-2xl glass-card p-5 border border-[#D5E8F7] dark:border-slate-800 cursor-pointer" onclick="toggleFaq('faq-2')">
            <div class="flex items-center justify-between font-headline font-bold text-slate-900 dark:text-white text-base">
              <span>How do student teams get academic credit for solving problems?</span>
              <span class="material-symbols-outlined text-brand-primary transition-transform duration-200" id="faq-icon-faq-2">expand_more</span>
            </div>
            <div id="faq-2" class="hidden mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-[#E2EFF8] dark:border-slate-800 pt-3">
              C2C is integrated directly with AICTE Activity Point guidelines. When a student team completes a ground solution endorsed by their faculty guide and municipal inspector, credits are pushed directly into their university transcript.
            </div>
          </div>

          <div class="rounded-2xl glass-card p-5 border border-[#D5E8F7] dark:border-slate-800 cursor-pointer" onclick="toggleFaq('faq-3')">
            <div class="flex items-center justify-between font-headline font-bold text-slate-900 dark:text-white text-base">
              <span>Are corporate CSR contributions audit-ready under Section 135?</span>
              <span class="material-symbols-outlined text-brand-primary transition-transform duration-200" id="faq-icon-faq-3">expand_more</span>
            </div>
            <div id="faq-3" class="hidden mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-[#E2EFF8] dark:border-slate-800 pt-3">
              Yes. All CSR contributions are managed via escrow contracts compliance-mapped to Companies Act Section 135. Automated milestone reports, municipal utilization certificates, and receipt tokens are generated upon every payout.
            </div>
          </div>

          <div class="rounded-2xl glass-card p-5 border border-[#D5E8F7] dark:border-slate-800 cursor-pointer" onclick="toggleFaq('faq-4')">
            <div class="flex items-center justify-between font-headline font-bold text-slate-900 dark:text-white text-base">
              <span>How can a new university or municipal body join C2C?</span>
              <span class="material-symbols-outlined text-brand-primary transition-transform duration-200" id="faq-icon-faq-4">expand_more</span>
            </div>
            <div id="faq-4" class="hidden mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-[#E2EFF8] dark:border-slate-800 pt-3">
              Institutional heads can register directly on the C2C portal using their official domain email (.edu.in or .gov.in). Account clearance takes less than 2 hours following automated credential verification.
            </div>
          </div>
    ...
    <section class="py-12">
      <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="rounded-3xl bg-gradient-to-r from-sky-600 via-brand-primary to-indigo-700 text-white p-8 sm:p-12 text-center shadow-sky-lg relative overflow-hidden">
          <div class="relative z-10 max-w-3xl mx-auto">
            <h2 class="font-headline font-extrabold text-3xl sm:text-4xl leading-tight">Ready to Transform Your Campus Innovation?</h2>
            <p class="text-sky-100 text-sm sm:text-base mt-4 font-medium">Join 32,000+ student engineers, 400+ colleges, and 18 district municipal bodies driving sovereign civic transformation.</p>
            <div class="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a href="code.html#challenges" class="px-7 py-3.5 rounded-xl bg-white text-slate-900 font-headline font-bold text-sm shadow-lg hover:bg-brand-tint transition-all">
                Launch Live App Mesh
              </a>
              <a href="code.html#dashboards" class="px-7 py-3.5 rounded-xl bg-sky-900/40 text-white border border-white/30 font-headline font-bold text-sm hover:bg-sky-900/60 transition-all">
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-10 border-b border-[#E2EFF8] dark:border-slate-800">
        ...
        <div class="flex flex-col gap-3">
          ...
          <ul class="flex flex-col gap-2 text-xs text-slate-500 dark:text-slate-400">
            <li><a href="about.html" class="hover:text-brand-deep transition-colors font-bold text-brand-primary">About Us & Platform Vision</a></li>
      ...
      <div class="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-400 text-xs">
        ...
        <div class="flex items-center gap-4">
          <a href="code.html" class="hover:text-brand-deep transition-colors">Platform Home</a>
          <a href="about.html" class="hover:text-brand-deep transition-colors">About C2C</a>
  ...
  <!-- BIO MODAL -->
  <div id="bio-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
    <div class="w-full max-w-lg rounded-3xl glass-card p-6 sm:p-8 relative border border-[#CAE7F7] shadow-2xl">
      <button onclick="closeBioModal()" class="absolute top-4 right-4 text-slate-400 hover:text-slate-600 text-xl font-bold">✕</button>
      <div class="flex items-center gap-4 mb-4">
        <img id="bio-img" src="" alt="" class="w-16 h-16 rounded-2xl object-cover ring-2 ring-brand-pastel"/>
        <div>
          <h3 id="bio-name" class="font-headline font-extrabold text-xl text-slate-900 dark:text-white"></h3>
          <p id="bio-role" class="text-xs font-bold text-brand-primary"></p>
          <span id="bio-org" class="text-[11px] text-slate-500"></span>
        </div>
      </div>
      <p id="bio-desc" class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-4 border-t border-[#E2EFF8] dark:border-slate-800 pt-3"></p>
      <div class="flex items-center justify-between pt-2">
        <span id="bio-badge" class="px-3 py-1 rounded-lg text-xs font-bold bg-brand-pastel text-brand-deep"></span>
        <button onclick="closeBioModal()" class="px-4 py-2 rounded-xl bg-brand-primary text-white font-bold text-xs">Close Profile</button>
      </div>
    </div>
  </div>

  <!-- SEARCH MODAL -->
  <div id="search-modal" class="hidden fixed inset-0 z-50 flex items-start justify-center pt-24 p-4 bg-slate-900/60 backdrop-blur-sm">
    <div class="w-full max-w-xl rounded-2xl glass-card p-4 border border-[#CAE7F7] shadow-2xl">
      <div class="flex items-center gap-3 border-b border-[#E2EFF8] dark:border-slate-800 pb-3">
        <span class="material-symbols-outlined text-brand-primary text-2xl">search</span>
        <input type="text" id="global-search-input" placeholder="Search C2C mission, leadership, pillars, or FAQ..." class="w-full bg-transparent text-sm text-slate-900 dark:text-white focus:outline-none placeholder:text-slate-400"/>
        <button onclick="toggleSearchModal()" class="text-slate-400 text-xs px-2 py-1 rounded bg-slate-100 dark:bg-slate-800">ESC</button>
      </div>
      <div class="py-4 text-xs text-slate-500 space-y-2">
        <div class="font-bold uppercase tracking-wider text-[10px] text-brand-deep">Quick Searches</div>
        <div class="flex flex-wrap gap-2">
          <a href="#mission" onclick="toggleSearchModal()" class="px-2.5 py-1 rounded-lg bg-brand-tint dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-brand-pastel">Mission Statement</a>
          <a href="#journey" onclick="toggleSearchModal()" class="px-2.5 py-1 rounded-lg bg-brand-tint dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-brand-pastel">SIH 2026 Inception</a>
          <a href="#leadership" onclick="toggleSearchModal()" class="px-2.5 py-1 rounded-lg bg-brand-tint dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-brand-pastel">Parnavi Janbhor</a>
          <a href="#pillars" onclick="toggleSearchModal()" class="px-2.5 py-1 rounded-lg bg-brand-tint dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-brand-pastel">CSR Escrow Rails</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    const bioData = {
      parnavi: {
        name: "Parnavi Janbhor",
        role: "Lead Innovator & Platform Architect",
        org: "Vidyalankar Institute of Technology (VSIT) • SIH 2026 Winner",
        desc: "Parnavi led the architectural conceptualization of Campus2Community during the Smart India Hackathon 2026. Specializing in AI agent orchestration and civic NLP modeling, she spearheaded the integration between student capstones and municipal SLAs.",
        badge: "SIH Grand Finalist Lead"
      },
      rajesh: {
        name: "Dr. Rajesh Verma",
        role: "Chief Academic Advisor",
        org: "Ex-AICTE Executive Director • Professor of Urban Tech",
        desc: "Dr. Verma brings over 25 years of experience in higher education policy and curriculum design. He authored the academic credit mapping matrix that enables C2C ground projects to count directly toward AICTE activity points.",
        badge: "AICTE Policy Pioneer"
      },
      ananya: {
        name: "Ananya Deshmukh",
        role: "Director of Civic Governance",
        org: "Municipal Administration Expert • Urban Development Specialist",
        desc: "Ananya oversees collectorate integrations and municipal NOC dispatch rails. Her work has streamlined public field testing permits across 18 district collectorates in record time.",
        badge: "18 Collectorates Synced"
      },
      vikram: {
        name: "Vikramaditya Rao",
        role: "Head of CSR Funding & Escrow",
        org: "Corporate Sustainability Board • Ex-Tata Trusts Escrow Lead",
        desc: "Vikramaditya designed the cryptographic milestone escrow pipeline that guarantees 100% statutory compliance under Companies Act Section 135 for corporate funding partners.",
        badge: "₹4.8 Cr Escrow Managed"
      }
    };

    function openBioModal(key) {
      const data = bioData[key];
      if (!data) return;
      document.getElementById('bio-name').textContent = data.name;
      document.getElementById('bio-role').textContent = data.role;
      document.getElementById('bio-org').textContent = data.org;
      document.getElementById('bio-desc').textContent = data.desc;
      document.getElementById('bio-badge').textContent = data.badge;
      document.getElementById('bio-img').src = document.querySelector(`[onclick="openBioModal('${key}')"] img`).src;
    ...
    function switchStakeholderTab(key) {
      const tabs = ['students', 'faculty', 'municipal', 'csr'];
      tabs.forEach(t => {
        const view = document.getElementById('st-view-' + t);
        const btn = document.getElementById('st-tab-' + t);
        if (t === key) {
          view.classList.remove('hidden');
          view.classList.add('block');
          btn.className = "px-5 py-2.5 rounded-xl text-xs font-bold bg-brand-pastel text-brand-deep shadow-sm transition-all flex items-center gap-2";
        } else {
          view.classList.add('hidden');
          view.classList.remove('block');
          btn.className = "px-5 py-2.5 rounded-xl text-xs font-semibold text-slate-600 hover:text-brand-deep transition-all flex items-center gap-2";
        }
      });
    }
    ...
    // Restore saved theme
    (function initTheme() {
      const savedTheme = localStorage.getItem('c2c-theme');
      if (savedTheme === 'dark') {
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // 4. MAGNETIC BUTTONS & RIPPLE ENGINE
